...
//                user.getCurrentDeal().setMoneyTo(List.of(new CurrencyAmount(selectedCurrency, 0d)));
//            } else if (user.getAmountType() == AmountType.RECEIVE) {
//                user.getCurrentDeal().setMoneyFrom(List.of(new CurrencyAmount(selectedCurrency, 0d)));
//            }
//
