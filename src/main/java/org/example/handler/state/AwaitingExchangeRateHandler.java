    ...
    public void handle(Message message, User user) {
        ...
        try {
            ...
            switch (deal.getDealType()) {
                ...
                case BUY -> {
                    deal.setAmountFrom((double) Math.round(deal.getAmountTo() * rate));
                }
                case SELL -> {
                    deal.setAmountTo((double) Math.round(deal.getAmountFrom() * rate));
                }
            }
